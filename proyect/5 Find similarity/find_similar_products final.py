...
# Show dimensions of the raings df dataframe
print("The dimension of the ratings cvs is:")
print(ratings_df.shape)

print("The dimension of the movies cvs is:")
...
# 6. Print the result, showing the 5 most similar movies to movieId #1
